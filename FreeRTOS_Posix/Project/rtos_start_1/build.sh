...
# rm ../Project/rtos_start_1/$APP_NAME_app_v$APP_VER
cp FreeRTOS_Posix ../Project/$APP_NAME/$APP_NAME"_app".bin
cp FreeRTOS_Posix ../Project/$APP_NAME/output/$APP_NAME"_app".bin
